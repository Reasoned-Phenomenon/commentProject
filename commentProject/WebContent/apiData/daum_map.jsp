...
var iwContent = '<div style="padding:5px;">'+str+'<br><a href="https://map.kakao.com/link/map/'+str+','+x_p+','+y_p+'" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/'+str+','+x_p+','+y_p+'" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
